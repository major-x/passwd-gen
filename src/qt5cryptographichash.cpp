...
class Qt5CryptographicHashPrivate
{
public:
    Qt5CryptographicHash::Algorithm method;
    union {
...
/*!
  \class Qt5CryptographicHash
  \inmodule QtCore

  \brief The Qt5CryptographicHash class provides a way to generate cryptographic hashes.
  ...
  Qt5CryptographicHash can be used to generate cryptographic hashes of binary or text data.

  Currently MD4, MD5, SHA-1, SHA-224, SHA-256, SHA-384, and SHA-512 are supported.
*/

/*!
  \enum Qt5CryptographicHash::Algorithm
...
*/
Qt5CryptographicHash::Qt5CryptographicHash(Algorithm method)
    : d(new Qt5CryptographicHashPrivate)
{
    d->method = method;
    reset();
}
...
/*!
  Destroys the object.
*/
Qt5CryptographicHash::~Qt5CryptographicHash()
{
    delete d;
}
...
/*!
  Resets the object.
*/
void Qt5CryptographicHash::reset()
{
    switch (d->method) {
    case Sha1:
    ...
    default:
        Q_ASSERT_X(false, "Qt5CryptographicHash", "Method not compiled in");
        Q_UNREACHABLE();
        break;
#else
    case Md4:
...
/*!
    ...
    hash.
*/
void Qt5CryptographicHash::addData(const char *data, int length)
{
    switch (d->method) {
    case Sha1:
...
/*!
  \overload addData()
*/
void Qt5CryptographicHash::addData(const QByteArray &data)
{
...
/*!
  ...
  \since 5.0
 */
bool Qt5CryptographicHash::addData(QIODevice* device)
{
...
/*!
  ...
  \sa QByteArray::toHex()
*/
QByteArray Qt5CryptographicHash::result() const
{
    if (!d->result.isEmpty())
        return d->result;
...
*/
QByteArray Qt5CryptographicHash::hash(const QByteArray &data, Algorithm method)
{
    Qt5CryptographicHash hash(method);
    hash.addData(data);
    return hash.result();
}
